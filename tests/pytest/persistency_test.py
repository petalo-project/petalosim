...
def test_hdf5_structure(petalosim_files):
...
def test_particle_ids_of_hits_exist_in_particle_table(petalosim_files):
    """
...
def test_hit_labels(petalosim_files):
...
def test_primary_always_exists(petalosim_files):
